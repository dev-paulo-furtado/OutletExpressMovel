    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFinalizarCompra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LiveData<Boolean> resultLD = compraViewModel.compra(pagamentoSelecionado, cpfSelecionado, cepSelecionado, ruaSelecionada, numeroSelecionado, codigo_produto_int, quantidade_produto_int);
